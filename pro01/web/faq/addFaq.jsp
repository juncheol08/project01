...
<div class="container">
    ...
    <div class="contents" id="contents">
        <div class="breadcrumb">
            <p><a href="/">HOME</a> &gt; <a href="/faq/faqList.jsp">게시판</a> &gt; <span>FAQ 글쓰기</span></p>
        </div>
        <section class="page" id="page1">
            <div class="page_wrap">
                <h2 class="page_tit">FAQ 글쓰기</h2>
                <hr>
                <form action="addFaqPro.jsp" method="post">
                    <table class="tb1">
                        <tbody>
                        <tr>
                            <th><label for="question">FAQ 글 제목</label></th>
                            <td>
                                <input type="text" name="question" id="question" class="indata" required>
                            </td>
                        </tr>
                        <tr>
                            <th><label for="answer">글 내용</label></th>
                            <td><textarea rows="10" cols="80" name="answer" id="answer" class="indata2" maxlength="990" required></textarea></td>
                        </tr>
                        <tr>
                            <td colspan="2">
