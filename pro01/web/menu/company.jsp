...
<head>
    ...
    <style>
        ...
        .tab_box li label {
            ...
            width: 100%;
            text-align: center;
            background-color: rgb(158, 250, 127);
        }

        .tab_box li label:hover {
            background-color: rgb(93, 176, 65);
            color: white;
            font-size: 20px;
        }
    ...
    <div class="wrap">
        ...
        <div class="contents">
            ...
            <section class="page" id="com">
                <div class="page_wrap">
                    <h2 class="page_tit">천재교육IT센터 커뮤니티 소개</h2>
                    <div class="com_content">
                        <h3 class="con_tit">학생과 선생님들 모두 함께 이야기하며</h3>
                        <h3 class="con_tit">쉴 수 있는 <span class="highlight">소통의 광장</span>이 되겠습니다.</h3>
                        <p class="cont">학생들 뿐만 아니라 선생님들도 함께 할 수 있는 <br>
                            커뮤니티 사이트 입니다.<br><br>

                            학생들에겐 다른 친구들과 소통이 가능한 게시판들과 선생님들에게서<br>
                            진로 상담도 가능합니다.<br><br>

                            수강생들에게 상담과 취업 정보 등을 공유 해줄 수 있으며, <br>
                            소통하며 유용한 정보들을 들을 수 있는 게시판을 제공하고 있습니다.</p>
                    </div>
                    <img src="../img/chunjae1.png" alt="" class="com_img">
                </div>
            </section>
