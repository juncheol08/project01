...
<div class="container">
    ...
    <div class="contents" id="contents">
        <div class="breadcrumb">
            <p><a href="/">HOME</a> &gt; <a href="/qna/qnaList.jsp">QnA</a> &gt; <span>질문하기</span></p>
        </div>
            ...
            <div class="page_wrap">
                ...
                <form action="addQuestionPro.jsp" method="post">
                    <table class="tb1">
                        ...
                        <tr>
                            <th>글 제목</th>
                            <td><input type="text" name="title" id="title" class="indata">
                        ...
                        <tr>
                            <td colspan="2">
                                ...
                                <input type="submit" value="글 쓰기" class="inbtn">
                            </td>
                        </tr>
