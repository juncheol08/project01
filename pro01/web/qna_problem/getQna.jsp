...
<head>
    ...
    <style>
        /* 본문 영역 스타일 */
        .contents { clear:both; min-height: 180vh; background-image: url("../img/backimg.png");
...
<%
    ...
    try{
        // 조회수 갱신 코드
        conn = con.connect();
        String sql = "update qna_problem set cnt=cnt+1 where par=? and lev=0";
        ...
        String sql2 = "select * from qna_problem where par=?";
            ...
            <div class="page_wrap">
                ...
                <table class="tb1">
                    ...
                    <tr>
                        ...
                        <td>조회수 <%=qnaList.get(0).getCnt()%></td>
                    </tr>
                    </thead>
                    <tbody>
                    <tr>
                ...
                <table class="tb2" id="myTable">
                    ...
                    <%
                        for(int i=1; i<qnaList.size(); i++) {
                            ...
                            String author = qnaList.get(i).getAuthor();
                    %>
                    <tr>
